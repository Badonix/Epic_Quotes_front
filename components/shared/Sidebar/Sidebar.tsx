...
const Sidebar: React.FC<{ sidebarActive: boolean; setSidebarActive: any }> = ({
  ...
  return (
    <>
      ...
      ></div>
      <div
        className={`z-30 lg:w-530 block lg:translate-x-0 pl-16 pt-9 transition-all lg:static h-4/5 rounded-r-xl w-11/12 max-w-lg absolute top-0 left-0 bg-sidebar lg:bg-transparent ${
